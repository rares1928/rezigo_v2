    ...
    <Card className={classes.root}>
      ...
      <CardContent className={classes.lowerPart}>
        ...
        >
          ...
          {/* {props.isCardSelected === "Test Standard" ? (
            <Checkbox
              checked={
                !props.listaSelectiiStandard
                  .filter(
                    (item, index) =>
                      props.listaCategorii[index]["book"] === props.book
                  )
              ...
              onChange={() => {
                props.setListaSelectiiStandard(
                  props.listaSelectiiStandard.map((element, index) =>
                    props.listaCategorii[index]["book"] === props.book
                      ? props.listaSelectiiStandard
                          .filter(
                            (item, index) =>
                          ...
                          .includes(false)
                      : props.listaSelectiiStandard[index]
                  )
                );
              }}
            ></Checkbox>
