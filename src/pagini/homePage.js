...
import CarouselTemplate from "../componente/carousel";
...
export default function HomePage() {
    ...
    useEffect(() => {
        setLoading(true);
        const url = "https://grileapiwin.azurewebsites.net/api/GetStatus?code=MtfWukjuzDqDGubbuJCnMnawGweSHuVD4NNalvRuo1dRs2REJIbAAg==";
        ...
        <div className={classes.wrapperDiv}>
                ...
                {loading ? (
                    ...
                    <div className={classes.instructionsText}>
                        <Typography variant="h6">
                            ...
                            {items.tip_profil === "Standard" ? <div>Astăzi mai poți rezolva {items.intrebariRamase} de grile</div> : null}
                            {items.tip_profil === "Premium" ? (
                                <>
                                    până la data de: {items.zileRamase.split("T")[0]} ora: {items.zileRamase.split("T")[1].replace(":00", "")}
                                </>
                            ) : (
                                ""
                            )}
            ...
            Grile rezolvate în ultimele 3 zile: {questionSolved}
                ...
                <Grid justifyContent="center" container spacing={6}>
                    ...
                    <Grid item>
                        <HomeCard imagine={profil} sendTo="/profil" title="Profil" text="Configurează setări, vezi statistici legate de teste" />
                    </Grid>
