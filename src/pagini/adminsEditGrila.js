...
export default function AdminsEditGrila() {
  ...
  const sendEmail = async () => {
    ...
    const url =
      "https://grileapiwin.azurewebsites.net/api/SendReportEmailAdmin?code=VgbFQ//X5Yb0KP6pmR0LIuOEHB8oYYjlgsS5gjukM8a9bPK4H2gMlw==";
  ...
  const deleteReport = (emailReport, complaint) => {
    ...
    const url =
      "https://grileapiwin.azurewebsites.net/api/deletereportadmin?code=haeOuBen/j143Sf5piYPwrf5wOxzaiexasond4uroUaLJsTONKU5MA==";
    const data = {
      grilaId: state,
  ...
  const updateGrila = () => {
    ...
    const url =
      "https://grileapiwin.azurewebsites.net/api/EditeazaGrila?code=Mik8i81eKx/6UL8G21W3LRpNSgm2naWAT07Ub4FB7rQreyHgm/OkVQ==";
    const data = {
      Intrebare: intrebare,
      GrilaId: state,
    ...
    <div className={classes.wrapperDiv}>
      ...
      >
        <Alert onClose={handleCloseAlert} severity="success">
          <Typography>Emailul a fost trimis!</Typography>
        </Alert>
      </Snackbar>
        ...
        {ready ? (
          <>
            ...
            <Paper className={classes.paper}>
              <Typography>Id grila: {state}</Typography>
              <Typography>Autor: {items.lista["Autor"]}</Typography>
              <Typography>
                Carte:{items.lista["Carte"]} ; Capitol:{" "}
                {items.lista["Categorie"]} ; Sub capitol:{" "}
                {items.lista["SubCategorie"]}
              </Typography>
              <div className={classes.tipGrileDiv}>
                <Typography>Tip Grila:</Typography>
                <Button
                  disableElevation
                  variant="contained"
                  color={
                    items.lista["TipGrile"] === "CS" ? "secondary" : "inherit"
                  }
                >
                  CS
                </Button>
                <Button
                  ...
                  variant="contained"
                  color={
                    items.lista["TipGrile"] === "CM" ? "secondary" : "inherit"
                  }
                >
                  CM
                </Button>
              </div>
              <Typography>{items.lista["Intrebare"]}</Typography>
              <Typography>a){items.lista["Variante"][0]}</Typography>
              <Typography>b){items.lista["Variante"][1]}</Typography>
              <Typography>c){items.lista["Variante"][2]}</Typography>
              <Typography>d){items.lista["Variante"][3]}</Typography>
              <Typography>e){items.lista["Variante"][4]}</Typography>
              <Typography>Explicatii: {items.lista["Explicatii"]}</Typography>
              <Typography>
                Raspunsuri numar: {items.lista["Raspunsuri_numar"]}
              </Typography>
              <div className={classes.raspunsuriDiv}>
                <Typography>Raspunsuri corecte:</Typography>
                <Button
                  disableElevation
                  variant="contained"
                  color={
                    items.lista["Raspunsuri"][0] === 1 ? "secondary" : "inherit"
                  }
                >
                  a)
                </Button>
                <Button
                  ...
                  variant="contained"
                  color={
                    items.lista["Raspunsuri"][1] === 1 ? "secondary" : "inherit"
                  }
                >
                  b)
                </Button>
                <Button
                  ...
                  variant="contained"
                  color={
                    items.lista["Raspunsuri"][2] === 1 ? "secondary" : "inherit"
                  }
                >
                  c)
                </Button>
                <Button
                  ...
                  variant="contained"
                  color={
                    items.lista["Raspunsuri"][3] === 1 ? "secondary" : "inherit"
                  }
                >
                  d)
                </Button>
                <Button
                  ...
                  variant="contained"
                  color={
                    items.lista["Raspunsuri"][4] === 1 ? "secondary" : "inherit"
                  }
                >
                  e)
                </Button>
            ...
            <Paper className={classes.paper}>
              ...
              <Typography>
                Raspunsuri numar:{" "}
                {16 * raspA + 8 * raspB + 4 * raspC + 2 * raspD + raspE}
              </Typography>
              <div className={classes.raspunsuriDiv}>
                <Typography>Raspunsuri corecte:</Typography>
                <Button
            ...
            <Paper className={classes.paper}>
              {items.lista["Reports"].length === 0 ? (
                <Typography>Nu exista niciun report</Typography>
              ) : (
                <div>
                  {items.lista["Reports"].map((report, index) => (
                    <div
                      key={"report_numar_" + String(index)}
                      className={classes.reportsDiv}
                    >
                      <Typography>
                        Creat la: {report["CreatedOn"].split("T")[0]} ora:{" "}
                        {report["CreatedOn"].split("T")[1].replace("00", "")}
                      </Typography>
                      <Typography>Email: {report["Email"]}</Typography>
                      <Typography>Complaint: {report["Complaint"]}</Typography>
                      <div className={classes.divButton}>
                        <Button
                          variant="contained"
                          color="primary"
                        ...
                        <Button
                          ...
                          className={classes.button}
                          onClick={() => {
                            deleteReport(report["Email"], report["Complaint"]);
                          }}
                        >
                          Sterge report
                        </Button>
            ...
            {showFormular ? (
              <Paper className={classes.paper}>
                <Typography className={classes.reportsDiv}>
                  Scrie mai jos mesajul mailului pe care vrei sa il trimiti la
                  adresa {reciver}:
                </Typography>
                <TextField
                ...
                <div className={classes.divButton}>
                  ...
                  >
                    {loading ? (
                      ...
                      <Typography>Trimite mailul</Typography>
                    )}
                  </Button>
                </div>
              </Paper>
