...
export default function AdminsSimuareEdit() {
	...
	const editOrder = async (grilaId, orderId) => {
		let url = "https://grileapiwin.azurewebsites.net/api/EditOrder?code=oZzWLFpqcPB1jZGpNbfo4gktVy1YJF6KaONVt1lLYwVIAzFumFUCoA==";
			...
			{loading ? (
				...
				<>
					<Paper className={classes.paper}>
						...
						<Typography className={classes.headerText} variant="h5">
							Vrei sa faci simularea live? Statusul ei curent este: {simulareCurenta.IsLive ? "live" : "offline"}
						</Typography>
						<Button
							size="large"
							className={classes.buttons}
